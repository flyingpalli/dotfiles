# Generated by Powerlevel10k configuration wizard on 2024-08-18 at 15:45 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#7f849c'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#bac2de}'  # grey foreground
      local      clean='%F{#bac2de}'  # grey foreground
      local   modified='%F{#bac2de}'  # grey foreground
      local  untracked='%F{#bac2de}'  # grey foreground
      local conflicted='%F{#bac2de}'  # grey foreground
    fi
