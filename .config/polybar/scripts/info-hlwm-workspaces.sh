            ...
            for i in "${tags[@]}" ; do
                ...
                case ${i:0:1} in
                    '#')
                        ...
                        echo "%{F#000}%{B#cba6f7}%{U#F28D35}" # Add your formatting tags for empty workspaces
                        ;;
                    ':')
                        # : the tag is not empty
                        # TODO Add your formatting tags for occupied workspaces
                        echo "%{F#cdd6f7}%{B#313244}" # Add your formatting tags for empty workspaces
                        ;;
                    '!')
                    ...
                    '-')
                        ...
                        echo "%{F#cdd6f7}%{B#6c7086}" # Add your formatting tags for empty workspaces
                        ;;
                    *)
                        # . the tag is empty
                        # There are also other possible prefixes but they won't appear here
                        echo "%{F#cdd6f7}%{B-}" # Add your formatting tags for empty workspaces
                        ;;
                esac
